...
Opgaven varer ca. 2-2.5 uger og omhandler både planlægningen og produktionen af client-side produktet. Opgaven skal planlægges, der skal udarbejdes designanalyse (identifikation af komponenter/moduler). Der skal udarbejdes funktionsliste til de enkelte komponenter. I skal samarbejde om projektet digitalt (eksempelvis ved hjælp af GitHub Projects / Trello), men det er også et krav, at I undervejs i processen vedligeholder et kanban-board, som kan bruges fx. ved de daglige scrum-møder. 

Der er afsat 3 dage til den indledende planlægning, hvorefter selve udførelsen af produktet afvikles i to sprints af cirka en uges varighed. I skal afholde et sprint-planning møde med jeres lærer forud for hvert sprint, ligesom der skal være et sprint-review af hvert sprint med jeres lærer. 
...
### Tekniske krav
**Client-Side** skal løses vha. HTML, CSS og Javascript, som ved hjælp af fetch-api'et henter data fra en eller flere JSON filer. Jeres CSS skal være modulær, og overholde BEM konventionen, samt principperne i SMACSS. Produktet **kan** designes efter mobile first princippet, men ikke nødvendigvis implementeret til begge platforme *(prioriter desktop varianten som den primære der produceres)*.


### Planlægning
* Layoutanalyse - identificer komponenter/moduler i layoutet. Husk at analysere indefra og ud.
* Funktionslister - Lav funktionslister til alle komponenter.
* Udarbejd 'definition of done' på de enkelte lister. Hvilke kriterier skal komponentet/modulet opfylde for at være færdigt? Hvad skal den som laver review kontrollere om er i orden?
* SPRINT PLANNING (husk at invitere jeres lærer) Prioriter jeres moduler og funktionslister og estimer dem, i vælger at arbejde med i det første sprint (planning poker)
